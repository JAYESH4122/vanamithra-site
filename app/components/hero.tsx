      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div ref={containerRef} className="lg:w-1/2 text-center lg:text-left">
            ...
            <p className="hero-item text-lg sm:text-2xl mb-6 sm:mb-8 text-white/90 leading-relaxed font-primary opacity-0">
            ...
            <div className="hero-item flex flex-col sm:flex-row gap-4 justify-center lg:justify-start opacity-0">
              <button
                ref={button1Ref}
                onClick={() => {

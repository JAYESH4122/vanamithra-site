          ...
          >
            ...
            >
              <button
                ...
                className="!bg-yellow text-black font-semibold py-3 px-6 sm:py-4 sm:px-8 rounded-xl hover:bg-primary-light transition-all duration-300 shadow-lg flex items-center justify-center gap-2 hover:scale-105"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
              ...
              <button className="border-2 border-surface text-white font-semibold py-3 px-6 sm:py-4 sm:px-8 rounded-xl hover:bg-surface hover:bg-opacity-10 transition-all duration-300 backdrop-blur-sm flex items-center justify-center gap-2">

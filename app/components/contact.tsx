        ...
        <div className="space-y-6">
          {contactData.contactItems.map((item, i) => {
            ...
            return (
              ...
              >
                {/* ICON WITH GRADIENT */}
                <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${item.gradient} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300 text-white`}>
                  {getIcon(item.icon)}
                </div>

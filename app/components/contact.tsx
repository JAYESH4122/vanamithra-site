        ...
        <div className="space-y-6">
          {contactData.contactItems.map((item, i) => {
            ...
            return (
              ...
              >
                {/* ICON */}
                <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${item.gradient} flex items-center justify-center text-white group-hover:scale-110 transition-transform`}>
                  {getIcon(item.icon)}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-primary-dark font-medium text-base truncate">{item.contact}</p>
                </div>
                ...
                <motion.div
                  ...
                  className="text-primary-dark opacity-0 group-hover:opacity-100 transition-all"
                >

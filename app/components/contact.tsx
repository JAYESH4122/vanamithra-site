...
export const ContactSection = () => {
  ...
  useGSAP(
    () => {
      // Master timeline for section animations
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 max-w-5xl">
        ...
        <div className="text-center mb-10 md:mb-16">
          <h2 className="contact-header text-3xl md:text-6xl font-bold text-white mb-4">
          ...
          <p className="contact-subtitle text-white text-base max-w-2xl mx-auto">

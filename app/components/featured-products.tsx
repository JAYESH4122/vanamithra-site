      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
          ...
          <Link href={featuredProductsData.cta.link}>
            <button className="featured-button hidden lg:flex items-center gap-2 bg-yellow text-white font-semibold py-3 px-6 rounded-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group opacity-0 active:scale-95">
            ...
            <div className="relative">
              ...
              >
                {featuredProducts.map((product) => (
                  <div
                    key={product.id}
                    className="featured-card relative z-10 hover:z-20 bg-white min-w-[85%] sm:min-w-0 flex-shrink-0 snap-center  border border-gray-100 rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300 overflow-hidden cursor-pointer group will-change-transform opacity-0"
        ...
        <div className="featured-mobile-button mt-12 text-center lg:hidden opacity-0">
          <Link href={featuredProductsData.cta.link}>
            <button className="bg-yellow text-white font-semibold py-4 px-8 rounded-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 w-full sm:w-auto active:scale-95">
              {featuredProductsData.cta.text}
            </button>
          </Link>
        </div>
